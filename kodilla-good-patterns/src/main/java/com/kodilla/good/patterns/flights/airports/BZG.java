...
public class BZG implements Airport {
    private String name;
    ...
    private void fillDestinationList() {
        ...
        Flight flight2 = new Flight(getName(), "Warszawa - Modlin", "WMI");
        Flight flight3 = new Flight(getName(), "Krakow - Balice", "KRK");
        Flight flight4 = new Flight(getName(), "Gdansk - Rebiechowo", "GDA");
