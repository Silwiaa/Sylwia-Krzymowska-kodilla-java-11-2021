...
public class ForumTestSuite {
    ...
    class TestPosts {
        ...
        @DisplayName("testRemovePostNotExisting()")
    ...
    class TestComments {
        ...
        @DisplayName("testRemoveCommentNotExisting()")
